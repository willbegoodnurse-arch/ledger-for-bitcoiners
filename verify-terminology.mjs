...
// 4. "판매 필요 BTC" 문구 존재
assert.match(combined, /판매 필요 BTC/, "'판매 필요 BTC' label is present");

// 5. "BTC 판매 반영" 문구 존재
assert.match(combined, /BTC 판매 반영/, "'BTC 판매 반영' label is present");

// 6. "BTC 판매 합계" 문구 존재
assert.match(combined, /BTC 판매 합계/, "'BTC 판매 합계' label is present");
